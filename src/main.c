...
/*   Updated: 2019/07/11 18:19:30 by dzboncak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main(int argc, char **argv)
{
	...
	paths_1 = NULL;
	paths_2 = NULL;
	get_paths(&paths_1, &paths_2, lem);
	if (total_steps(paths_1, lem) <= total_steps(paths_2, lem))
		ants_contribution(paths_1, lem);
	else
		ants_contribution(paths_2, lem);
	return (0);
}
